...
if __name__ == "__main__":
	...
	newline2 = "file:/cms/xaastorage/NanoAOD/2018/JUNE19/GJetsHTBinned_Test/GJetsHT_200to400/jetToolbox_nano_mc_2018GJetsHT200to400_"+str(process)+".root"

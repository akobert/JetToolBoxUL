...
if __name__ == "__main__":
	...
	newline2 = "file:/cms/xaastorage/NanoAOD/2018/JUNE19/VectorZPrimeGammaToQQGamma_M25_temp/jetToolbox_nano_m25signal"+str(process)+".root"

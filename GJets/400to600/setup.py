...
if __name__ == "__main__":
	...
	newline2 = "file:/cms/xaastorage/NanoAOD/2018/JUNE19/GJetsHTBinned_Test/GJetsHT_400to600/jetToolbox_nano_mc_2018GJetsHT400to600_"+str(process)+".root"
